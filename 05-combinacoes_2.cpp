...
int produtorio(int val_final, int val_inicial = 1){
...
int num_combinacoes(int conjunto, int combinacoes){
	int num_comb = conjunto - combinacoes;
	return produtorio(conjunto, num_comb + 1) / (produtorio(combinacoes));
}
